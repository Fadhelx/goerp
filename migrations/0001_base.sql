...
CREATE TABLE IF NOT EXISTS ir_module_category (
  id BIGSERIAL PRIMARY KEY,
  name TEXT NOT NULL,
  parent_id BIGINT,
  child_ids TEXT,
...
CREATE TABLE IF NOT EXISTS ir_model (
  ...
  is_mail_thread BOOLEAN NOT NULL DEFAULT false,
  is_mail_activity BOOLEAN NOT NULL DEFAULT false,
  is_mail_blacklist BOOLEAN NOT NULL DEFAULT false
);
...
CREATE TABLE IF NOT EXISTS ir_model_fields (
  id BIGSERIAL PRIMARY KEY,
  model TEXT NOT NULL,
  name TEXT NOT NULL,
  ttype TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS ir_model_data (
  ...
  CONSTRAINT ir_model_data_name_nospaces CHECK (name NOT LIKE '% %'),
  CONSTRAINT ir_model_data_module_name_uniq UNIQUE (module, name)
);
...
CREATE TABLE IF NOT EXISTS ir_default (
  id BIGSERIAL PRIMARY KEY,
  model TEXT NOT NULL,
  field TEXT NOT NULL,
  value TEXT
...
CREATE TABLE IF NOT EXISTS res_config_settings (
  id BIGSERIAL PRIMARY KEY,
  company_id BIGINT,
  is_root_company BOOLEAN NOT NULL DEFAULT false,
  module_base_import BOOLEAN NOT NULL DEFAULT false,
  module_google_calendar BOOLEAN NOT NULL DEFAULT false,
  module_microsoft_calendar BOOLEAN NOT NULL DEFAULT false,
  module_mail_plugin BOOLEAN NOT NULL DEFAULT false,
  module_auth_oauth BOOLEAN NOT NULL DEFAULT false,
  module_auth_ldap BOOLEAN NOT NULL DEFAULT false,
  module_account_inter_company_rules BOOLEAN NOT NULL DEFAULT false,
  module_voip BOOLEAN NOT NULL DEFAULT false,
  module_web_unsplash BOOLEAN NOT NULL DEFAULT false,
  module_sms BOOLEAN NOT NULL DEFAULT false,
  module_partner_autocomplete BOOLEAN NOT NULL DEFAULT false,
  module_base_geolocalize BOOLEAN NOT NULL DEFAULT false,
  module_google_recaptcha BOOLEAN NOT NULL DEFAULT false,
  module_website_cf_turnstile BOOLEAN NOT NULL DEFAULT false,
  module_google_address_autocomplete BOOLEAN NOT NULL DEFAULT false,
  report_footer TEXT,
  group_multi_currency BOOLEAN NOT NULL DEFAULT false,
  external_report_layout_id BIGINT,
  ...
  company_country_group_codes TEXT,
  profiling_enabled_until TIMESTAMPTZ,
  has_accounting_entries BOOLEAN NOT NULL DEFAULT false,
  currency_id BIGINT,
  has_chart_of_accounts BOOLEAN NOT NULL DEFAULT false,
  chart_template TEXT,
  sale_tax_id BIGINT,
  purchase_tax_id BIGINT,
  account_price_include TEXT,
  tax_calculation_rounding_method TEXT,
  module_account_accountant BOOLEAN NOT NULL DEFAULT false,
  group_cash_rounding BOOLEAN NOT NULL DEFAULT false,
  show_sale_receipts BOOLEAN NOT NULL DEFAULT false,
  module_account_budget BOOLEAN NOT NULL DEFAULT false,
  module_account_payment BOOLEAN NOT NULL DEFAULT false,
  module_account_reports BOOLEAN NOT NULL DEFAULT false,
  module_account_check_printing BOOLEAN NOT NULL DEFAULT false,
  module_account_batch_payment BOOLEAN NOT NULL DEFAULT false,
  module_currency_rate_live BOOLEAN NOT NULL DEFAULT false,
  module_product_margin BOOLEAN NOT NULL DEFAULT false,
  tax_exigibility BOOLEAN NOT NULL DEFAULT false,
  use_invoice_terms BOOLEAN NOT NULL DEFAULT false,
  terms_type TEXT,
  invoice_terms TEXT,
  invoice_terms_html TEXT,
  preview_ready BOOLEAN NOT NULL DEFAULT false,
  group_sale_delivery_address BOOLEAN NOT NULL DEFAULT false,
  group_uom BOOLEAN NOT NULL DEFAULT false,
  group_analytic_accounting BOOLEAN NOT NULL DEFAULT false,
  digest_emails BOOLEAN NOT NULL DEFAULT false,
  digest_id BIGINT,
  portal_allow_api_keys BOOLEAN NOT NULL DEFAULT false,
  country_code TEXT,
  income_account_id BIGINT,
  expense_account_id BIGINT,
  account_fiscal_country_id BIGINT
);

CREATE TABLE IF NOT EXISTS ir_cron (
  id BIGSERIAL PRIMARY KEY,
  name TEXT NOT NULL,
  ir_actions_server_id BIGINT,
  cron_name TEXT,
  active BOOLEAN NOT NULL DEFAULT true,
  interval_number INTEGER NOT NULL DEFAULT 1,
  interval_type TEXT NOT NULL DEFAULT 'minutes',
  nextcall TIMESTAMPTZ,
  lastcall TIMESTAMPTZ,
  user_id BIGINT,
  model_id BIGINT,
  state TEXT,
  code TEXT,
  ...
  first_failure_date TIMESTAMPTZ,
  action_name TEXT
);

CREATE TABLE IF NOT EXISTS ir_cron_trigger (
  id BIGSERIAL PRIMARY KEY,
  cron_id BIGINT NOT NULL,
  call_at TIMESTAMPTZ NOT NULL
);

CREATE TABLE IF NOT EXISTS ir_cron_progress (
  id BIGSERIAL PRIMARY KEY,
  cron_id BIGINT NOT NULL,
  done INTEGER NOT NULL DEFAULT 0,
  remaining INTEGER NOT NULL DEFAULT 0,
  deactivate BOOLEAN NOT NULL DEFAULT false,
  timed_out_counter INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS base_automation (
  ...
  model_is_mail_thread BOOLEAN NOT NULL DEFAULT false,
  active BOOLEAN NOT NULL DEFAULT true,
  trigger TEXT NOT NULL,
  trigger_field_names TEXT,
  trigger_field_ids TEXT,
  on_change_field_ids TEXT,
  filter_pre_domain TEXT,
  previous_domain TEXT,
  filter_domain TEXT,
  action_server_id BIGINT,
  action_server_ids TEXT,
  url TEXT,
  webhook_uuid TEXT,
  record_getter TEXT,
  log_webhook_calls BOOLEAN NOT NULL DEFAULT false,
  last_run TIMESTAMPTZ,
  trg_selection_field_id BIGINT,
  trg_field_ref_model_name TEXT,
  trg_field_ref TEXT,
  trg_date_id BIGINT,
  trg_date_range INTEGER,
  trg_date_range_mode TEXT,
  trg_date_range_type TEXT,
  trg_date_calendar_id BIGINT
);
...
CREATE TABLE IF NOT EXISTS mail_message (
  ...
  incoming_email_cc TEXT,
  outgoing_email_to TEXT,
  reply_to TEXT,
  reply_to_force_new BOOLEAN NOT NULL DEFAULT false,
  mail_server_id BIGINT,
  email_layout_xmlid TEXT,
  email_add_signature BOOLEAN NOT NULL DEFAULT true,
  date TIMESTAMPTZ,
  parent_id BIGINT,
  subtype_id BIGINT,
  mail_activity_type_id BIGINT,
  partner_ids TEXT,
  attachment_ids TEXT,
  ...
  starred_partner_ids TEXT,
  tracking_value_ids TEXT,
  create_uid BIGINT,
...
CREATE TABLE IF NOT EXISTS mail_message_reaction (
  ...
  partner_id BIGINT,
  guest_id BIGINT,
  CONSTRAINT mail_message_reaction_partner_or_guest_exists
...
CREATE TABLE IF NOT EXISTS mail_activity (
  ...
  recommended_activity_type_id BIGINT,
  previous_activity_type_id BIGINT,
  ...
  hide_in_chatter BOOLEAN NOT NULL DEFAULT false,
  attachment_ids TEXT,
  active BOOLEAN NOT NULL DEFAULT true,
...
CREATE TABLE IF NOT EXISTS mail_activity_type (
  id BIGSERIAL PRIMARY KEY,
  name TEXT NOT NULL,
  summary TEXT,
  res_model TEXT,
  ...
  delay_from TEXT NOT NULL DEFAULT 'previous_activity',
  chaining_type TEXT NOT NULL DEFAULT 'suggest',
  triggered_next_type_id BIGINT,
  suggested_next_type_ids TEXT,
  previous_type_ids TEXT,
  icon TEXT,
  active BOOLEAN NOT NULL DEFAULT true
);
...
CREATE TABLE IF NOT EXISTS mail_alias (
  ...
  model_name TEXT,
  alias_model_id BIGINT,
  alias_defaults TEXT NOT NULL DEFAULT '{}',
  alias_force_thread_id BIGINT,
  alias_parent_model_id BIGINT,
  alias_parent_thread_id BIGINT,
  alias_contact TEXT NOT NULL DEFAULT 'everyone',
  alias_incoming_local BOOLEAN NOT NULL DEFAULT false,
  alias_bounced_content TEXT,
  alias_status TEXT,
  alias_user_id BIGINT,
  alias_domain_id BIGINT,
  alias_domain TEXT,
  alias_full_name TEXT,
  active BOOLEAN NOT NULL DEFAULT true
);
...
CREATE TABLE IF NOT EXISTS mail_message_subtype (
  id BIGSERIAL PRIMARY KEY,
  name TEXT NOT NULL,
  res_model TEXT,
  default_subtype BOOLEAN NOT NULL DEFAULT false,
  internal BOOLEAN NOT NULL DEFAULT false
);

CREATE TABLE IF NOT EXISTS fetchmail_server (
  id BIGSERIAL PRIMARY KEY,
  name TEXT NOT NULL,
  active BOOLEAN NOT NULL DEFAULT true,
  state TEXT,
  ...
  port INTEGER,
  server_type TEXT,
  server_type_info TEXT,
  is_ssl BOOLEAN NOT NULL DEFAULT false,
  attach BOOLEAN NOT NULL DEFAULT true,
...
CREATE TABLE IF NOT EXISTS res_country (
  ...
  zip_required BOOLEAN NOT NULL DEFAULT false,
  name_position TEXT,
  active BOOLEAN NOT NULL DEFAULT true
);

CREATE TABLE IF NOT EXISTS res_country_group (
  id BIGSERIAL PRIMARY KEY,
  name TEXT NOT NULL,
  code TEXT,
  country_ids TEXT
...
CREATE TABLE IF NOT EXISTS res_groups_privilege (
  id BIGSERIAL PRIMARY KEY,
  name TEXT NOT NULL,
  description TEXT,
  placeholder TEXT,
...
CREATE TABLE IF NOT EXISTS res_users_settings (
  id BIGSERIAL PRIMARY KEY,
  user_id BIGINT,
  is_discuss_sidebar_category_channel_open BOOLEAN NOT NULL DEFAULT true,
  is_discuss_sidebar_category_chat_open BOOLEAN NOT NULL DEFAULT true
);

CREATE TABLE IF NOT EXISTS res_users_apikeys (
  id BIGSERIAL PRIMARY KEY,
  name TEXT NOT NULL,
  user_id BIGINT,
  scope TEXT,
...
CREATE TABLE IF NOT EXISTS res_users_identitycheck (
  id BIGSERIAL PRIMARY KEY,
  create_uid BIGINT,
  user_id BIGINT,
  request TEXT
...
CREATE TABLE IF NOT EXISTS change_password_user (
  id BIGSERIAL PRIMARY KEY,
  create_uid BIGINT,
  user_id BIGINT,
  new_passwd TEXT
...
CREATE TABLE IF NOT EXISTS change_password_own (
  id BIGSERIAL PRIMARY KEY,
  create_uid BIGINT,
  user_id BIGINT,
  new_passwd TEXT
...
CREATE TABLE IF NOT EXISTS res_device_log (
  id BIGSERIAL PRIMARY KEY,
  device_id BIGINT,
  user_id BIGINT
);
...
CREATE TABLE IF NOT EXISTS ir_ui_view_custom (
  id BIGSERIAL PRIMARY KEY,
  user_id BIGINT,
  ref_id BIGINT,
  arch TEXT
...
CREATE TABLE IF NOT EXISTS properties_base_definition (
  id BIGSERIAL PRIMARY KEY,
  name TEXT
);
...
CREATE TABLE IF NOT EXISTS ir_filters (
  id BIGSERIAL PRIMARY KEY,
  name TEXT NOT NULL,
  model_id TEXT,
  domain TEXT,
  ...
  user_id BIGINT,
  action_id BIGINT,
  embedded_action_id BIGINT,
  is_default BOOLEAN NOT NULL DEFAULT false,
  active BOOLEAN NOT NULL DEFAULT true
);

CREATE TABLE IF NOT EXISTS ir_asset (
  id BIGSERIAL PRIMARY KEY,
  name TEXT NOT NULL,
  active BOOLEAN NOT NULL DEFAULT true,
  bundle TEXT,
...
CREATE TABLE IF NOT EXISTS ir_actions_todo (
  id BIGSERIAL PRIMARY KEY,
  name TEXT,
  action_id BIGINT,
  state TEXT,
...
CREATE TABLE IF NOT EXISTS discuss_channel (
  id BIGSERIAL PRIMARY KEY,
  name TEXT NOT NULL,
  channel_type TEXT,
  active BOOLEAN NOT NULL DEFAULT true,
...
CREATE TABLE IF NOT EXISTS discuss_channel_member (
  id BIGSERIAL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS mail_guest (
  id BIGSERIAL PRIMARY KEY,
  name TEXT,
  email TEXT
);
...
CREATE TABLE IF NOT EXISTS product_category (
  ...
  property_account_income_categ_id BIGINT,
  property_account_expense_categ_id BIGINT
);
...
CREATE TABLE IF NOT EXISTS product_template (
  ...
  product_variant_count INTEGER NOT NULL DEFAULT 0,
  barcode TEXT,
  default_code TEXT,
  is_favorite BOOLEAN NOT NULL DEFAULT false,
  product_tag_ids TEXT,
  taxes_id TEXT,
  tax_string TEXT,
  supplier_taxes_id TEXT,
  property_account_income_id BIGINT,
  property_account_expense_id BIGINT,
  account_tag_ids TEXT,
  fiscal_country_codes TEXT
);
...
CREATE TABLE IF NOT EXISTS account_analytic_applicability (
  id BIGSERIAL PRIMARY KEY,
  analytic_plan_id BIGINT,
  business_domain TEXT,
  applicability TEXT,
  account_prefix TEXT,
  product_categ_id BIGINT,
  display_account_prefix BOOLEAN NOT NULL DEFAULT false,
  account_prefix_placeholder TEXT,
  company_id BIGINT
);
...
CREATE TABLE IF NOT EXISTS account_analytic_account (
  ...
  vendor_bill_count INTEGER NOT NULL DEFAULT 0
);
...
CREATE TABLE IF NOT EXISTS account_analytic_distribution_model (
  ...
  prefix_placeholder TEXT
);

CREATE TABLE IF NOT EXISTS digest_digest (
  id BIGSERIAL PRIMARY KEY,
  name TEXT NOT NULL,
  active BOOLEAN NOT NULL DEFAULT true,
  company_id BIGINT,
  ...
  state TEXT,
  kpi_res_users_connected BOOLEAN NOT NULL DEFAULT false,
  kpi_res_users_connected_value INTEGER,
  kpi_mail_message_total BOOLEAN NOT NULL DEFAULT false,
  kpi_mail_message_total_value INTEGER,
  kpi_account_total_revenue BOOLEAN NOT NULL DEFAULT false,
  kpi_account_total_revenue_value NUMERIC
);

CREATE TABLE IF NOT EXISTS digest_tip (
  id BIGSERIAL PRIMARY KEY,
  name TEXT NOT NULL,
  sequence INTEGER,
  group_id BIGINT,
...
CREATE TABLE IF NOT EXISTS onboarding_onboarding (
  id BIGSERIAL PRIMARY KEY,
  name TEXT,
  route_name TEXT NOT NULL,
  step_ids TEXT,
  text_completed TEXT,
  is_per_company BOOLEAN NOT NULL DEFAULT false,
  panel_close_action_name TEXT,
  current_progress_id BIGINT,
  current_onboarding_state TEXT,
  is_onboarding_closed BOOLEAN NOT NULL DEFAULT false,
  progress_ids TEXT,
  sequence INTEGER
);
...
CREATE TABLE IF NOT EXISTS onboarding_onboarding_step (
  ...
  done_text TEXT,
  step_image BYTEA,
  step_image_filename TEXT,
  step_image_alt TEXT,
  panel_step_open_action_name TEXT,
  current_progress_step_id BIGINT,
  current_step_state TEXT,
  progress_ids TEXT,
  is_per_company BOOLEAN NOT NULL DEFAULT true,
  sequence INTEGER
);
...
CREATE TABLE IF NOT EXISTS onboarding_progress (
  ...
  company_id BIGINT,
  progress_step_ids TEXT,
  onboarding_state TEXT,
  is_onboarding_closed BOOLEAN NOT NULL DEFAULT false
);

CREATE TABLE IF NOT EXISTS onboarding_progress_step (
  id BIGSERIAL PRIMARY KEY,
  step_id BIGINT,
  progress_ids TEXT,
  company_id BIGINT,
...
CREATE TABLE IF NOT EXISTS portal_wizard (
  id BIGSERIAL PRIMARY KEY,
  partner_ids TEXT,
  user_ids TEXT,
...
CREATE TABLE IF NOT EXISTS portal_wizard_user (
  id BIGSERIAL PRIMARY KEY,
  wizard_id BIGINT,
  partner_id BIGINT,
  email TEXT,
...
CREATE TABLE IF NOT EXISTS portal_share (
  id BIGSERIAL PRIMARY KEY,
  res_model TEXT,
  res_id BIGINT,
  partner_ids TEXT,
...
CREATE TABLE IF NOT EXISTS account_account (
  ...
  include_initial_balance BOOLEAN NOT NULL DEFAULT false,
  internal_group TEXT,
  root_id BIGINT,
  group_id BIGINT,
  company_id BIGINT,
  ...
  non_trade BOOLEAN NOT NULL DEFAULT false,
  tax_ids TEXT
);
...
CREATE TABLE IF NOT EXISTS account_chart_template (
  id BIGSERIAL PRIMARY KEY,
  name TEXT NOT NULL,
  code_digits INTEGER,
  currency_id BIGINT,
...
CREATE TABLE IF NOT EXISTS account_code_mapping (
  id BIGSERIAL PRIMARY KEY,
  name TEXT NOT NULL,
  company_id BIGINT,
  account_id BIGINT,
...
CREATE TABLE IF NOT EXISTS account_journal (
  ...
  sequence_number_next INTEGER NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS account_move (
  ...
  payment_state TEXT,
  status_in_payment TEXT,
  is_move_sent BOOLEAN NOT NULL DEFAULT false,
  sending_data TEXT,
  is_being_sent BOOLEAN NOT NULL DEFAULT false,
  invoice_pdf_report_id BIGINT,
  invoice_pdf_report_file TEXT,
  ...
  matched_payment_ids TEXT,
  reconciled_payment_ids TEXT,
  payment_count INTEGER NOT NULL DEFAULT 0,
  posted_before BOOLEAN NOT NULL DEFAULT false,
  inalterable_hash TEXT,
  sequence_prefix TEXT,
  sequence_number INTEGER,
  made_sequence_gap BOOLEAN NOT NULL DEFAULT false,
  secure_sequence_number INTEGER,
  auto_post TEXT NOT NULL DEFAULT 'no',
  need_cancel_request BOOLEAN NOT NULL DEFAULT false,
  show_reset_to_draft_button BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE IF NOT EXISTS account_move_line (
  ...
  product_id BIGINT,
  product_uom_id BIGINT,
  allowed_uom_ids TEXT,
  product_category_id BIGINT,
  analytic_line_ids TEXT,
  analytic_distribution TEXT,
  distribution_analytic_account_ids TEXT,
  analytic_precision INTEGER,
  has_invalid_analytics BOOLEAN NOT NULL DEFAULT false,
  ...
  matched_debit_ids TEXT,
  matched_credit_ids TEXT,
  tax_ids TEXT,
  tax_tag_ids TEXT,
  tax_line_id BIGINT,
...
CREATE TABLE IF NOT EXISTS account_tax (
  ...
  company_id BIGINT,
  tax_group_id BIGINT,
  fiscal_position_ids TEXT,
  original_tax_ids TEXT,
  children_tax_ids TEXT,
...
CREATE TABLE IF NOT EXISTS account_tax_group (
  ...
  name TEXT NOT NULL,
  country_id BIGINT,
  tax_payable_account_id BIGINT,
  tax_receivable_account_id BIGINT,
  company_id BIGINT,
...
CREATE TABLE IF NOT EXISTS account_tax_repartition_line (
  ...
  company_id BIGINT,
  document_type TEXT,
  repartition_type TEXT,
  factor_percent NUMERIC,
  account_id BIGINT,
  tag_ids TEXT,
  sequence INTEGER NOT NULL DEFAULT 1
);
...
CREATE TABLE IF NOT EXISTS account_partial_reconcile (
  id BIGSERIAL PRIMARY KEY,
  debit_move_id BIGINT NOT NULL,
  credit_move_id BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS account_report_external_value (
  id BIGSERIAL PRIMARY KEY,
  name TEXT,
  target_report_expression_id BIGINT,
  company_id BIGINT,
  date DATE,
  value NUMERIC
);
...
CREATE TABLE IF NOT EXISTS ai_agent (
  ...
  source_ids TEXT,
  sources_ids TEXT,
  sources_fully_processed BOOLEAN NOT NULL DEFAULT true,
  is_ask_ai_agent BOOLEAN NOT NULL DEFAULT false,
  tool_allowlist TEXT,
  company_id BIGINT
);

CREATE TABLE IF NOT EXISTS ai_topic (
  id BIGSERIAL PRIMARY KEY,
  name TEXT NOT NULL,
  description TEXT,
  instructions TEXT,
...
CREATE TABLE IF NOT EXISTS ai_agent_source (
  id BIGSERIAL PRIMARY KEY,
  name TEXT NOT NULL,
  agent_id BIGINT,
...
CREATE TABLE IF NOT EXISTS ai_prompt_button (
  id BIGSERIAL PRIMARY KEY,
  name TEXT NOT NULL,
  prompt TEXT,
  model_name TEXT,
...
CREATE TABLE IF NOT EXISTS ai_embedding (
  ...
  has_embedding_generation_failed BOOLEAN NOT NULL DEFAULT false,
  embedding_vector TEXT,
  metadata TEXT,
  company_id BIGINT
);

CREATE TABLE IF NOT EXISTS ai_composer (
  id BIGSERIAL PRIMARY KEY,
  name TEXT NOT NULL,
  interface_key TEXT,
  focused_models TEXT,
  ai_agent BIGINT,
  default_prompt TEXT,
  available_prompt_ids TEXT,
  available_prompts TEXT,
...
CREATE TABLE IF NOT EXISTS ai_settings (
  ...
  secret_source TEXT,
  secret_ref TEXT,
  openai_key_enabled BOOLEAN NOT NULL DEFAULT false,
  openai_key TEXT,
  google_key_enabled BOOLEAN NOT NULL DEFAULT false,
  google_key TEXT,
  company_id BIGINT
);
...
CREATE TABLE IF NOT EXISTS approval_settings (
  ...
  model TEXT NOT NULL,
  active BOOLEAN NOT NULL DEFAULT true,
  state_field TEXT NOT NULL DEFAULT 'state',
  draft_state TEXT,
  approved_state TEXT,
  rejected_state TEXT,
...
CREATE TABLE IF NOT EXISTS approval_settings_state (
  id BIGSERIAL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS approval_config (
  ...
  sequence INTEGER NOT NULL DEFAULT 10,
  group_ids TEXT,
  user_python_code TEXT,
  condition TEXT,
  schedule_activity BOOLEAN NOT NULL DEFAULT true,
  schedule_activity_field_id BIGINT,
  schedule_activity_days INTEGER,
  button_ids TEXT,
  escalation_ids TEXT,
  escalation_count INTEGER,
  tag_ids TEXT,
  auto_approve BOOLEAN NOT NULL DEFAULT false,
  default_mail_template_body TEXT,
  default_reject_mail_template_body TEXT,
  committee BOOLEAN NOT NULL DEFAULT false,
  committee_limit INTEGER,
  committee_vote_percentage DOUBLE PRECISION,
  user_ids TEXT,
  is_voting BOOLEAN NOT NULL DEFAULT false,
  active BOOLEAN NOT NULL DEFAULT true
);

CREATE TABLE IF NOT EXISTS approval_buttons (
  id BIGSERIAL PRIMARY KEY,
  settings_id BIGINT NOT NULL,
  config_id BIGINT,
  model TEXT,
  ...
  email_wizard_form_id BIGINT,
  email_next_action TEXT,
  group_ids TEXT,
...
CREATE TABLE IF NOT EXISTS approval_automation (
  ...
  filter_domain TEXT,
  template_ids TEXT,
  server_action_ids TEXT,
  action_dsl TEXT
);

CREATE TABLE IF NOT EXISTS approval_escalation (
  id BIGSERIAL PRIMARY KEY,
  settings_id BIGINT NOT NULL,
  name TEXT NOT NULL,
  state_value TEXT,
...
CREATE TABLE IF NOT EXISTS approval_log (
  ...
  approval_button_id BIGINT,
  bulk_approval BOOLEAN NOT NULL DEFAULT false,
  old_node_id BIGINT,
  new_node_id BIGINT,
  workflow_transition_id BIGINT,
  delegation_id BIGINT,
  delegation_employee_id BIGINT
);

CREATE TABLE IF NOT EXISTS approval_log_voting (
  id BIGSERIAL PRIMARY KEY,
  user_id BIGINT,
  vote TEXT,
  button_id BIGINT,
...
CREATE TABLE IF NOT EXISTS approval_forward (
  id BIGSERIAL PRIMARY KEY,
  model TEXT NOT NULL,
  record_id BIGINT NOT NULL,
  approval_state_id BIGINT,
  state_value TEXT,
...
CREATE TABLE IF NOT EXISTS workflow_node (
  ...
  active BOOLEAN NOT NULL DEFAULT true,
  type TEXT,
  responsible_group_ids TEXT,
  responsible_user_ids TEXT,
  responsible_python_code TEXT,
  responsible_condition TEXT,
  schedule_activity BOOLEAN NOT NULL DEFAULT false,
  schedule_activity_field_id BIGINT,
  schedule_activity_days INTEGER,
  state TEXT,
  button_type TEXT,
  ...
  escalation_delay_type TEXT,
  escalation_delay INTEGER,
  escalation_node_id BIGINT
);
...
CREATE TABLE IF NOT EXISTS workflow_transition (
  ...
  sequence INTEGER NOT NULL DEFAULT 10,
  active BOOLEAN NOT NULL DEFAULT true,
  run_as_superuser BOOLEAN NOT NULL DEFAULT false,
  condition TEXT,
  code TEXT,
  ...
  committee BOOLEAN NOT NULL DEFAULT false,
  committee_limit INTEGER,
  validate_form BOOLEAN NOT NULL DEFAULT false,
  trigger TEXT,
...
CREATE TABLE IF NOT EXISTS workflow_node_action (
  id BIGSERIAL PRIMARY KEY,
  node_id BIGINT NOT NULL,
  sequence INTEGER NOT NULL DEFAULT 10,
  active BOOLEAN NOT NULL DEFAULT true,
  condition TEXT,
  server_action_id BIGINT NOT NULL,
  action_key TEXT
);
...
CREATE TABLE IF NOT EXISTS workflow_process (
  ...
  started_at TIMESTAMPTZ,
  updated_at TIMESTAMPTZ,
  approval_user_ids TEXT,
  approval_done_user_ids TEXT,
  approval_partner_ids TEXT,
  user_can_approve BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE IF NOT EXISTS delegation_line (
  id BIGSERIAL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS login_as_route (
  id BIGSERIAL PRIMARY KEY,
  name TEXT NOT NULL,
  path TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS res_users (
  ...
  name TEXT,
  active BOOLEAN NOT NULL DEFAULT true,
  active_partner BOOLEAN NOT NULL DEFAULT true,
  login_date TIMESTAMPTZ,
  company_id BIGINT,
  company_ids TEXT,
  groups_id TEXT,
  group_ids TEXT,
  all_group_ids TEXT,
  accesses_count INTEGER,
  rules_count INTEGER,
  groups_count INTEGER,
  view_group_hierarchy JSONB,
  role TEXT,
  partner_id BIGINT,
  commercial_partner_id BIGINT,
  ...
  image_1920 TEXT,
  notification_type TEXT,
  outgoing_mail_server_id BIGINT,
  outgoing_mail_server_type TEXT,
  has_external_mail_server BOOLEAN NOT NULL DEFAULT false,
  employee_ids TEXT,
  employee_id BIGINT,
  job_title TEXT,
  work_phone TEXT,
  ...
  create_employee BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE IF NOT EXISTS res_groups (
  ...
  privilege_id BIGINT,
  implied_ids TEXT,
  all_implied_ids TEXT,
  implied_by_ids TEXT,
  all_implied_by_ids TEXT,
  disjoint_ids TEXT,
  user_ids TEXT,
  all_user_ids TEXT,
  ...
  delegation_template_ids TEXT,
  name_delegation TEXT,
  allow_multiple_delegation BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE IF NOT EXISTS res_partner_industry (
  id BIGSERIAL PRIMARY KEY,
  name TEXT NOT NULL,
  full_name TEXT
);
...
CREATE TABLE IF NOT EXISTS ir_ui_view (
  ...
  customize_show BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE IF NOT EXISTS ir_act_server (
  ...
  update_m2m_operation TEXT,
  update_boolean_value TEXT,
  warning TEXT,
...
CREATE TABLE IF NOT EXISTS ir_mail_server (
  id BIGSERIAL PRIMARY KEY,
  name TEXT,
  active BOOLEAN NOT NULL DEFAULT true,
  smtp_host TEXT,
  ...
  max_email_size INTEGER,
  smtp_user TEXT,
  smtp_pass TEXT,
  smtp_ssl_certificate TEXT,
  smtp_ssl_private_key TEXT,
  owner_user_id BIGINT,
  owner_limit_time TIMESTAMPTZ,
