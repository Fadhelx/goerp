...
func TestManifestDataFilesLoad(t *testing.T) {
	...
	for _, name := range []string{
		...
		"base.action_ir_actions_actions",
		"base.action_ir_actions_act_window",
		"base.action_ir_actions_report",
		"base.action_ir_actions_client",
		"base.action_ir_actions_act_url",
		"base.action_ir_embedded_actions",
		"base.action_ir_actions_todo",
		"base.action_ir_model_data",
		"base.action_ir_model_constraint",
		"base.action_ir_model_relation",
		"base.action_ir_model_fields_selection",
		"base.action_ir_sequence",
		"base.action_ir_cron_trigger",
		"base.action_decimal_precision",
		"base.action_ir_config_parameter",
		"base.action_ir_default",
		"base.action_ir_attachment",
		"base.action_ir_asset",
		"base.action_ir_logging",
		"base.action_ir_profile",
		"base.action_report_paperformat",
		"base.action_ir_ui_view_custom",
		"base.action_ir_filters",
		"base.action_res_lang",
		"base.action_res_device",
		"base.action_mail_message_subtype",
		"base.action_mail_tracking_value",
		"base.action_mail_notification",
		"base.action_mail_followers",
		"base.action_mail_activity",
		"base.action_mail_activity_type",
		"base.action_mail_scheduled_message",
		"base.action_mail_canned_response",
		"base.action_mail_alias",
		"base.action_mail_alias_domain",
		"base.action_mail_gateway_allowed",
		"base.action_mail_blacklist",
		"base.action_mail_guest",
		"base.action_mail_message_reaction",
		"base.action_res_users_settings",
		...
		"base.access_mail_message_subtype_group_system",
		"base.access_mail_tracking_value_group_system",
		"base.access_mail_notification_group_system",
		"base.access_mail_followers_group_system",
		"base.access_mail_activity_group_system",
		"base.access_mail_activity_type_group_system",
		"base.access_mail_scheduled_message_group_system",
		"base.access_mail_canned_response_group_system",
		"base.access_mail_alias_group_system",
		"base.access_mail_alias_domain_group_system",
		"base.access_mail_gateway_allowed_group_system",
		"base.access_mail_blacklist_group_system",
		"base.access_mail_guest_group_system",
		"base.access_mail_message_reaction_group_system",
		"base.menu_administration",
		"base.menu_general_settings",
		"base.menu_users",
		"base.menu_users_users",
		"base.menu_users_groups",
		"base.menu_users_companies",
		"base.menu_translations",
		"base.menu_translations_languages",
		"base.menu_technical",
		"base.menu_technical_actions",
		"base.menu_ir_actions_actions",
		"base.menu_ir_actions_act_window",
		"base.menu_ir_actions_server",
		"base.menu_ir_actions_report",
		"base.menu_ir_actions_client",
		"base.menu_ir_actions_act_url",
		"base.menu_ir_embedded_actions",
		"base.menu_ir_default",
		"base.menu_ir_actions_todo",
		"base.menu_technical_automation",
		"base.menu_ir_cron",
		"base.menu_base_automation",
		"base.menu_ir_cron_trigger",
		"base.menu_technical_user_interface",
		"base.menu_ir_ui_view",
		"base.menu_ir_ui_menu",
		"base.menu_ir_ui_view_custom",
		"base.menu_ir_filters",
		"base.menu_technical_database_structure",
		"base.menu_ir_model",
		"base.menu_ir_model_fields",
		"base.menu_ir_model_fields_selection",
		"base.menu_ir_model_constraint",
		"base.menu_ir_model_relation",
		"base.menu_ir_attachment",
		"base.menu_ir_asset",
		"base.menu_ir_logging",
		"base.menu_decimal_precision",
		"base.menu_ir_profile",
		"base.menu_technical_security",
		"base.menu_ir_model_access",
		"base.menu_ir_rule",
		"base.menu_res_device",
		...
		"base.menu_mail_scheduled_message",
		"base.menu_mail_message_subtype",
		"base.menu_mail_tracking_value",
		"base.menu_mail_notification",
		"base.menu_mail_followers",
		"base.menu_mail_alias",
		"base.menu_mail_alias_domain",
		"base.menu_mail_blacklist",
		"base.menu_mail_canned_response",
		"base.menu_mail_guest",
		"base.menu_mail_message_reaction",
		"base.menu_mail_activity",
		"base.menu_mail_activity_type",
		"base.menu_res_users_settings",
		"base.menu_mail_gateway_allowed",
		"base.menu_technical_reporting",
		"base.menu_report_paperformat",
		"base.menu_report_actions",
		"base.menu_technical_parameters",
		"base.menu_ir_config_parameter",
		"base.menu_technical_sequences",
		"base.menu_ir_sequence",
		"base.menu_ir_model_data",
...
func TestSecurityModelsExposeOdooFields(t *testing.T) {
	...
	assertFields(t, models["ir.cron"], "name", "ir_actions_server_id", "cron_name", "active", "group_ids", "interval_number", "interval_type", "nextcall", "lastcall", "model_id", "state", "code", "priority", "failure_count", "first_failure_date")
