...
var BaseMigrations = []Migration{
	...
	{Version: 8, Name: "ir_cron", SQL: `CREATE TABLE IF NOT EXISTS ir_cron (id BIGSERIAL PRIMARY KEY, name TEXT NOT NULL, ir_actions_server_id BIGINT, cron_name TEXT, active BOOLEAN NOT NULL DEFAULT true, group_ids TEXT, interval_number INTEGER NOT NULL DEFAULT 1, interval_type TEXT NOT NULL DEFAULT 'minutes', nextcall TIMESTAMPTZ, lastcall TIMESTAMPTZ, user_id BIGINT, model_id BIGINT, state TEXT, code TEXT, priority INTEGER NOT NULL DEFAULT 5, failure_count INTEGER NOT NULL DEFAULT 0, first_failure_date TIMESTAMPTZ, action_name TEXT)`},
	...
	{Version: 78, Name: "delegation", SQL: `CREATE TABLE IF NOT EXISTS delegation (id BIGSERIAL PRIMARY KEY, name TEXT, date_from DATE NOT NULL, date_to DATE NOT NULL, employee_id BIGINT, user_id BIGINT NOT NULL, one_employee BOOLEAN NOT NULL DEFAULT false, "delegateTo_employee_id" BIGINT, delegate_to_employee_id BIGINT, delegate_to_user_id BIGINT, isactive BOOLEAN NOT NULL DEFAULT false, state TEXT NOT NULL DEFAULT 'draft', department_ids TEXT, source_model TEXT, source_record_id BIGINT, metadata TEXT)`},
	...
	{Version: 86, Name: "res_users", SQL: `CREATE TABLE IF NOT EXISTS res_users (id BIGSERIAL PRIMARY KEY, login TEXT, password TEXT, email TEXT, name TEXT, lang TEXT, tz TEXT, active BOOLEAN NOT NULL DEFAULT true, active_partner BOOLEAN NOT NULL DEFAULT true, company_id BIGINT, company_ids TEXT, groups_id TEXT, group_ids TEXT, all_group_ids TEXT, accesses_count INTEGER, rules_count INTEGER, groups_count INTEGER, view_group_hierarchy JSONB, role TEXT, partner_id BIGINT, commercial_partner_id BIGINT, share BOOLEAN NOT NULL DEFAULT false, signature TEXT, image_1920 TEXT)`},
...
ALTER TABLE ir_cron ADD COLUMN IF NOT EXISTS group_ids TEXT;
...
`},
	{Version: 218, Name: "delegation_source_field_metadata", SQL: `
...
`},
	{Version: 223, Name: "res_users_preferences_fields", SQL: `
