...
RUNTIME_TEST_GROUP_5 := ^Test(BootstrapOIAIToolActionsAndTopics|BootstrapOIRegistersAIProcessSourcesAction|RuntimeAIToolActionsRunFromServerActions|RuntimeAIProcessSources.*|BootstrapOIExposesHTTPModulesAssetsMenusAndViews|BootstrapOIDelegationWebViewsAndActionMetadata|BootstrapWebNormalUserCanOpenRecordsListAndForm|BootstrapOIAIGenerateResponse.*|RuntimeAIDraftChannelCallKWCreatesContext|RuntimeAIAskAIActionAlwaysCreatesNewChannel|AIProviderResolver.*|AISettingsEnvUsesSystemContext|RuntimeAIActionRunsSelectedToolAndLogsSummary|RuntimeSecretRef.*|AssetsFromSources.*)$$
