...
assert.equal(findAll(actionManager, (node) => String(node.className).includes("o_setting_box")).length, 20);
assert.equal(findAll(actionManager, (node) => node.dataset?.hasSettingsAction === "true").length, 18);
